...
echo
    ...
    echo " ❯❯❯ ถ้าคุณติดตั้งทับจะทำให้ OpenVPN ใช้งานไม่ได้  ."
    echo " ❯❯❯ ต้องการรันต่อหรือไม่ ."
    read -p " Y/n : " FF
    if [[ "$FF" = "y" || "$FF" = "Y" ]]; then
    clear
   echo
...
dpkg -l xl2tpd > /dev/null 2>&1
if [[ $? -eq 0 ]]; then
echo
    echo " ❯❯❯ ได้ติดตั้ง L2TP ใว้แล้วก่อนหน้านี้  ."
    echo " ❯❯❯ ต้องการรันทับหรือไม่ ."
    read -p " Y/n : " FF
    if [[ "$FF" = "y" || "$FF" = "Y" ]]; then
    clear
   echo
...
bigecho "Trying to auto discover IP of trm smile
echo "clear" >> .bashrc
echo -e " cr
"
...
cd /usr/bin
wget -q -O l2tp http://smile-vpn.net/sc_rip/sm_sc/L2TP/add_l2tp.sh
chmod +x l2tp
...
echo "ติดตั้งสำเร็จ" > /usr/bin/.l2tp_fulle
echo "ติดตั้งสำเร็จ" > /usr/bin/.350_fulle

clear
cr
echo "        ╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮ 
        ┣ ติดตั้งเสดเรียบร้อยพิมพ์ l2tp เพื่อใช้งาน
        ╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯ 
"
exit 0
